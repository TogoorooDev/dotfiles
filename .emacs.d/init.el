...
(custom-set-variables
 ...
 '(package-selected-packages
   '(clojure-mode use-package go-eldoc dashboard all-the-icons projectile page-break-lines lsp-mode go-autocomplete key-chord go-mode yasnippet web-mode emmet-mode company-web))
 '(tab-bar-mode t))
(custom-set-faces
